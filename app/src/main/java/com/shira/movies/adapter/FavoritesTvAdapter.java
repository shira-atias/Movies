...
public class FavoritesTvAdapter extends RecyclerView.Adapter<FavoritesTvAdapter.ViewHolder>{
    private List<Tv> tvList;

    public FavoritesTvAdapter(List<Tv> tvList) {
        this.tvList = tvList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v ->
                Navigation.findNavController(v).navigate(R.id.action_navigation_favorites_to_detailsFragment,arg));
